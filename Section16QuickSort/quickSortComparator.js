function quickSort(arr, comparator = (a, b) => a - b, leftIndex = 0, rightIndex = arr.length - 1) {
  if (leftIndex < rightIndex) {
    let pivotIndex = pivot(arr, comparator, leftIndex, rightIndex);
    quickSort(arr, comparator, leftIndex, pivotIndex - 1);
    quickSort(arr, comparator, pivotIndex + 1, rightIndex);
  }
  return arr;
}
...
console.log(quickSort(arr3, strLength));